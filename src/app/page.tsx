  ...
  return (
    <div className="relative min-h-screen text-slate-900 selection:bg-teal-500/30 dark:bg-slate-950 dark:text-slate-100 transition-colors duration-500">
      ...
      <div className="relative overflow-x-hidden">
        <div
          aria-hidden
          className="pointer-events-none absolute inset-x-0 -top-32 h-[520px] opacity-40 [mask-image:radial-gradient(60%_50%_at_50%_40%,black,transparent)]"
        >
      ...
      <section className="relative border-t border-gray-200/50 dark:border-gray-800/60 bg-transparent text-gray-900 dark:text-gray-100">
        <div className="container mx-auto max-w-7xl px-4 py-14 sm:py-20 md:py-24">
          <Reveal>
          ...
          <Parallax className="cards-section relative overflow-x-hidden mt-10 sm:mt-12 left-1/2 -translate-x-1/2 w-[100vw] max-w-[100vw]" speed={0.05}>
            <GlassPanel
      ...
      <section className="relative z-10 pt-16 md:pt-20 pb-24 md:pb-32 bg-transparent">
        <div className="container mx-auto px-4">
          ...
          <div className="cards-section relative overflow-x-hidden left-1/2 -translate-x-1/2 w-[100vw] max-w-[100vw]">
            <GlassPanel
              className="cards-section rounded-none shadow-[0_20px_80px_rgba(0,0,0,0.12)] transition-shadow duration-500 hover:ring-1 hover:ring-white/20"
              bgClassName="bg-white/0"
              blurClassName="backdrop-blur-2xl backdrop-saturate-150"
      ...
      <section className="py-20 md:py-28 relative border-t border-gray-200/0">
        ...
        <Parallax className="cards-section relative overflow-x-hidden left-1/2 -translate-x-1/2 w-[100vw] max-w-[100vw]" speed={0.04}>
      ...
      {testimonials.length > 0 && (
        <section className="py-20 md:py-28 bg-transparent relative">
          <div className="container mx-auto px-4">
            ...
            <Parallax className="cards-section relative overflow-x-hidden left-1/2 -translate-x-1/2 w-[100vw] max-w-[100vw]" speed={0.03}>
              <GlassPanel
                className="cards-section rounded-none shadow-[0_20px_80px_rgba(0,0,0,0.12)] transition-shadow duration-500 hover:ring-1 hover:ring-white/20"
                bgClassName="bg-white/0"
                blurClassName="backdrop-blur-2xl backdrop-saturate-150"
                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-10 py-10 sm:py-14 md:py-18">
                  <Stagger className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                    {testimonials.map((t: { quote: string; author: string; role: string; rating: number; image: string | null }, i: number) => (
                      <div key={i} className="rounded-2xl p-7 md:p-8 border border-white/30 bg-white/60 backdrop-blur-sm text-slate-900 shadow-md transition-all duration-300 ease-out hover:-translate-y-1 hover:scale-[1.02] hover:shadow-[0_16px_48px_rgba(0,0,0,0.25)] hover:bg-white/70 hover:border-white/50">
      ...
      {faqs.length > 0 && (
        <section className="py-20 md:py-28 bg-transparent border-t border-gray-200/50 dark:border-gray-800/60 relative">
          <div className="container mx-auto px-4 max-w-5xl">
            ...
            <Parallax className="cards-section relative overflow-x-hidden left-1/2 -translate-x-1/2 w-[100vw] max-w-[100vw]" speed={0.025}>
              <GlassPanel
                className="cards-section rounded-none shadow-[0_20px_80px_rgba(0,0,0,0.12)] transition-shadow duration-500 hover:ring-1 hover:ring-white/20"
                bgClassName="bg-white/0"
                blurClassName="backdrop-blur-2xl backdrop-saturate-150"
                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-10 py-10 sm:py-14 md:py-18">
                  <Stagger className="space-y-5 md:space-y-7">
                    {faqs.map((faq: { question: string; answer: string }, i: number) => (
                      <div key={i} className="rounded-2xl border border-teal-500/15 bg-white/20 backdrop-blur-sm p-6 md:p-7 transition-all duration-300 ease-out hover:-translate-y-1 hover:scale-[1.01] hover:bg-white/30 hover:border-teal-500/30 shadow-sm hover:shadow-md">
      ...
      <section className="relative py-24 md:py-36 overflow-hidden bg-gradient-to-b from-primary to-primary-dark text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-7 sm:mb-10">
