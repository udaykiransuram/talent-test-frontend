...
export const Hero3D = ({ whatsappHref }: { whatsappHref?: string }) => {
  ...
  return (
    ...
    >
      {/* WhatsApp floating action on hero (home page) as a pill with text */}
      {(whatsappHref || envWaHref) && (
        <div className="absolute right-4 bottom-4 z-20">
          <a
            ...
            className="group inline-flex items-center gap-2 rounded-full bg-[#25D366] text-white px-4 py-2 shadow-lg hover:bg-[#1ebd5a] transition-colors"
          >
