...
export const Hero3D = ({ whatsappHref }: { whatsappHref?: string }) => {
  ...
  return (
    ...
    >
      {/* WhatsApp floating action on hero (home page) */}
      {(whatsappHref || envWaHref) && (
        <a
          ...
          className="absolute right-4 bottom-4 z-20 flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg hover:bg-[#1ebd5a] transition-colors"
        >
