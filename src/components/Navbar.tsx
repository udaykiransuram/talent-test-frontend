...
export default function Navbar() {
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-5 sm:px-8 md:px-16 flex h-20 items-center justify-between">
        {/* Logo */}
      ...
      {mounted && mobileMenuOpen && createPortal(
        ...
        >
          <nav className="mx-auto max-w-7xl px-5 sm:px-8 md:px-16 flex flex-col py-3 text-slate-900" role="menu" aria-label="Mobile Navigation">
            {navItems.map((item) => {
